...
public class Proxy {
    ...
    public static void main(String[] args) throws SocketException, IOException, InterruptedException {
        ...
        String receberC;
        String enviarC;
        ServerSocket servidorTCP = new ServerSocket(2000);
        //TCP - FIN
        System.out.println("Proxy ligado e à escuta na porta 5555");
        while (true) {
    ...
    public static InetAddress escolheServidor() throws UnknownHostException {
        ...
        for (InetAddress a : listaMonitores.keySet()) {
            ...
            if (caux >= listaMonitores.get(a).getCarga()) {
                caux = listaMonitores.get(a).getCarga();
                ipaux = a;
            }
        }
